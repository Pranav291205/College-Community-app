...
class _SocietiesPageState extends State<SocietiesPage> {
  ...
  final List<Map<String, dynamic>> technicalSocieties = [
    {
  ...
  Widget build(BuildContext context) {
    final societies = isTechSelected ? technicalSocieties : culturalSocieties;
      ...
      child: ClipRRect(
        ...
        child: BackdropFilter(
          ...
          child: Container(
            ...
            child: Row(
              children: [
                _toggleButton("Cultural", !isTechSelected, () {
                  setState(() => isTechSelected = false);
                }),
                _toggleButton("Technical", isTechSelected, () {
                  setState(() => isTechSelected = true);
                }),
              ],
            ),
          ),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return _buildPhotoCard(photos[index], color);
                    },
                  ),
                ),
              ],
  ...
  Widget _buildPhotoCard(String path, Color color) {
    return Container(
      width: 260,
